    ...
    <section id="main-content" class=" ">
        <section class="wrapper main-wrapper" style=''>
            ...
            <div class="col-xl-12 col-lg-12 col-12 col-md-12">
                <section class="box ">
                    <img src="{{ asset('uploads/banner/'.$banner->image) }}" class="img-fluid" id="view-img" alt="Banner sem imagem" style="width: 100%">
                </section>
            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                                ...
                                <form action="{{ route('banner.update', ['banner'=>$banner->id]) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="url" class="form-control" name="link" id="link" placeholder="Opcional" value="{{ $banner->link }}">
                                    </div>
