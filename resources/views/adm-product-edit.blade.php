                            ...
                            <div class="col-lg-12 col-md-12 col-12">
                                ...
                                <form action="{{ route('product.update', ['product'=>$product->id]) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" value="{{ $product->name }}" placeholder="Preencha este ..." required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="autoNumeric form-control" name="price" id="price" value="{{ $product->price }}" data-a-sign="R$ "  data-a-sep="." data-a-dec=",">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="category">Categoria</label>
                                        <input type="text" class="form-control" name="category" id="category" value="{{ $product->category }}" placeholder="Preencha este ..." required>
                                    </div>

                                    <div class="form-group">
                                        <label for="description">Descrição</label>
                                        <textarea name="description" class="bootstrap-wysihtml5-textarea" placeholder="Preencha este ..." style="width: 100%; height: 250px; font-size: 14px; line-height: 23px;padding:15px;" required>
                                            {!! $product->description !!}
                                        </textarea>
                                    </div>
