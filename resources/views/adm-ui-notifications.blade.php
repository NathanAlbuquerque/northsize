...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin Bootstrap 4 : Alert & Notifications</title>
                    ...
                    <ul class='wraplist'>
                        ...
                        <li class="open">
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="ui-notifications.html" >Alert &amp; Notifications</a>
                                </li>
                                <li>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
                        <div class="page-title">
                            ...
                            <div class="float-left">
                                <h1 class="title">Alert & Notifications</h1>                            </div>
                            ...
                            <div class="float-right d-none">
                                <ol class="breadcrumb">
                                    ...
                                    <li>
                                        <a href="ui-typography.html">UI Elements</a>
                                    </li>
                                    <li class="active">
                    ...
                    <div class="col-xl-12">
                        <section class="box ">
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-lg-12 col-md-12 col-12 notification_btns">
                                        <p>
                                            <button class="btn btn-danger" onclick="showErrorMessage('Ops! Something went wrong')">Show Error Messsage</button>
                                            <button class="btn btn-primary" onclick="showSuccess('Your message has been succeeded')">Show Success Messsage</button>
                                            <button class="btn btn-success" onclick="progressMessage()">Inprogress Message</button>
                                        </p>
