...
<head>
    ...
    <!-- Slick Carousel -->
    @Vite(['resources/vendor/slick-1.8.1/slick/slick.css'])
    @Vite(['resources/vendor/slick-1.8.1/slick/slick-theme.css'])
    <!-- App -->
...
<body>
    ...
    <!-- Slick Carousel -->
    @Vite(['resources/vendor/slick-1.8.1/slick/slick.min.js'])
    <!-- App -->
